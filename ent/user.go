...
type User struct {
	...
	// CurrentAt holds the value of the "current_at" field.
...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case user.FieldNickname, user.FieldName, user.FieldState, user.FieldPassword:
			values[i] = new(sql.NullString)
		case user.FieldCreateTime, user.FieldUpdateTime, user.FieldCurrentAt:
...
func (u *User) assignValues(columns []string, values []interface{}) error {
	...
	for i := range columns {
		...
		case user.FieldCurrentAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field current_at", values[i])
			} else if value.Valid {
				u.CurrentAt = value.Time
			}
		case user.FieldURL:
...
func (u *User) String() string {
	...
	builder.WriteString(", current_at=")
	builder.WriteString(u.CurrentAt.Format(time.ANSIC))
