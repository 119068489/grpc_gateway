...
// CurrentAt applies equality check predicate on the "current_at" field. It's identical to CurrentAtEQ.
func CurrentAt(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCurrentAt), v))
	})
}
...
// CurrentAtEQ applies the EQ predicate on the "current_at" field.
func CurrentAtEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCurrentAt), v))
	})
}

// CurrentAtNEQ applies the NEQ predicate on the "current_at" field.
func CurrentAtNEQ(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldCurrentAt), v))
	})
}

// CurrentAtIn applies the In predicate on the "current_at" field.
func CurrentAtIn(vs ...time.Time) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldCurrentAt), v...))
	})
}

// CurrentAtNotIn applies the NotIn predicate on the "current_at" field.
func CurrentAtNotIn(vs ...time.Time) predicate.User {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.User(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldCurrentAt), v...))
	})
}

// CurrentAtGT applies the GT predicate on the "current_at" field.
func CurrentAtGT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldCurrentAt), v))
	})
}

// CurrentAtGTE applies the GTE predicate on the "current_at" field.
func CurrentAtGTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldCurrentAt), v))
	})
}

// CurrentAtLT applies the LT predicate on the "current_at" field.
func CurrentAtLT(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldCurrentAt), v))
	})
}

// CurrentAtLTE applies the LTE predicate on the "current_at" field.
func CurrentAtLTE(v time.Time) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldCurrentAt), v))
	})
}
