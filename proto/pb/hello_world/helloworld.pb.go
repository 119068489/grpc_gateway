...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x85, 0x01, 0x0a, 0x07, 0x47,
	0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x3c, 0x0a, 0x08, 0x53, 0x61, 0x75, 0x48, 0x65, 0x6c,
	...
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x3c, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	...
	0x6c, 0x79, 0x42, 0x0e, 0x5a, 0x0c, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x5f, 0x77, 0x6f, 0x72,
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.Greeter.SauHello:input_type -> helloworld.HelloRequest
	0, // 1: helloworld.Greeter.SayHello:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.Greeter.SauHello:output_type -> helloworld.HelloReply
...
type GreeterClient interface {
	SauHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error)
...
func (c *greeterClient) SauHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/helloworld.Greeter/SauHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	SauHello(context.Context, *HelloRequest) (*HelloReply, error)
...
func (*UnimplementedGreeterServer) SauHello(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SauHello not implemented")
}
...
func _Greeter_SauHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).SauHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.Greeter/SauHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SauHello(ctx, req.(*HelloRequest))
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SauHello",
			Handler:    _Greeter_SauHello_Handler,
		},
		{
			MethodName: "SayHello",
